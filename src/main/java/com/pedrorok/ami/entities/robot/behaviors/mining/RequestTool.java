...
public class RequestTool extends ExtendedBehaviour<RobotEntity> {
	...
	protected void start(ServerLevel level, RobotEntity entity, long gameTime) {
		...
		ProjectAmi.adventure().audience(owner).sendMessage(MiniMessage.miniMessage().deserialize(
			"<green>[A.M.I.]</green> <gray>Could you please provide me with a pickaxe? I need it to mine blocks.</gray>"
		));
	}
}
